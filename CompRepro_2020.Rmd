...
we could use R and R studio together to construct project and basically we could manage any type of data during our research. 

For the storing of data, we should save moren than one copy of data. And both raw and processed data should be saved. 
